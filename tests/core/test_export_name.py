...
def test_movie_name_has_year_and_no_scope() -> None:
    ...
    assert name == "Example Movie 2024_1080p_h264_sdr_dash_hls_aac2.0-EXAMPLE"


def test_movie_without_year() -> None:
    assert export_name([movie(year=None)], [video()], "EXAMPLE") == "Example Movie_1080p_h264_sdr_dash-EXAMPLE"
...
def test_full_season_is_the_season_number() -> None:
    ...
    assert name == "Example Show S01_1080p_h264_sdr_dash_dd5.1-EXAMPLE"
...
def test_non_contiguous_subset_lists_each_run() -> None:
    ...
    assert export_name(titles, [], "EXAMPLE", seasons_of((1, 10))) == "Example Show S01E01-E02_S01E05_S01E09-EXAMPLE"
...
def test_many_runs_are_cut_short() -> None:
    ...
    assert name == "Example Show S01E01_S01E03_S01E05_+3-EXAMPLE"
...
def test_whole_season_and_a_partial_season() -> None:
    ...
    assert export_name(titles, [], "EXAMPLE", seasons_of((1, 2), (2, 4))) == "Example Show S01_S02E01-EXAMPLE"
...
def test_quality_parts_are_deduplicated_and_ordered() -> None:
    ...
    assert name == "Example Movie 2024_2160p_1080p_h264_h265_sdr_hdr10_dv_dash_ism_aac2.0_ddp5.1atmos_ddp2.0-EXAMPLE"
...
def test_song_uses_artist_and_album() -> None:
    ...
    assert export_name([song], [audio(codec=Audio.Codec.FLAC)], "EXAMPLE") == (
        "Example Artist - Example Album_dash_flac2.0-EXAMPLE"
    )
...
def test_export_is_renamed_as_titles_arrive_and_stays_valid(tmp_path: Path) -> None:
    ...
    partial = tmp_path / "Example Show S01E01_1080p_h264_sdr_dash-EXAMPLE.json"
    ...
    final = tmp_path / "Example Show S01_1080p_h264_sdr_dash-EXAMPLE.json"
